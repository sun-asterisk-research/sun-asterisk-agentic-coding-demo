...
Your goal is to create a clear and concise specification file for the feature or project that the user describes.

The specification should be saved in the `/context/` directory and named descriptively (e.g., `specs.md`, `feature-specs.md`).
...
1. Ask the user what feature or project they want to create a specification for (if not already provided)
...
7. Save the file in the `/context/` directory with a descriptive name
...
After creating the specification, present it to the user for review and ask if they'd like any modifications.
